        ...
        if($row['PASSWORD']==null){
          ...
          if ($result) {
            ...
            if (mail($to,$subject,$message,$headers)) {
              $GLOBALS['alert_info'] .= DaddToBsAlert("Password has been sent to your mail id. Please check and login!");
            }else{
              $GLOBALS['alert_info'] .= DaddToBsAlert("Error occured! Please try again!".$errorm);
            }
          }
        }else{
          echo '<div class=container><div class="alert alert-warning">Password exists! Please go <a href="forgotPassword">here</a></div></div>';
        }
      }
    }
  }
          ...
          <div class="col-md-6 col-lg-6 col-sm-12 ml-auto mr-auto">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Get Password</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <form method="POST">
