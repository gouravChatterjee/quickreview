...
if (isset($_POST['submit'])) {
  ...
  $unid = D_create_UserId();       
	$stmt = $link->prepare("INSERT INTO REVIEWS (`UNI_ID`, `PRODUCT_ID`, `PRODUCT_TYPE`, `USER_ID`, `USER_NAME`, `REVIEW_DETAILS`, `RATING`, `IMAGE`) VALUES (?, ?, 'SERVICE', ?, ?, ?, ?, ?)");
          ...
          <div class="row">
              ...
              <?php 
                if ($imgName == '' || $imgName == null) {
                  ...
                  echo '<img src="/CONTENT/UPLOADS/SERVICES/'.$id.'/'.$imgName.'" height="300" width="100%" alt="">';
                }
          	...
          	<div class="col-lg-6 col-sm-12">
          		...
          		<h3><a href="<?php echo $linkDe; ?>" class="btn btn-success" title="Click to buy the service"> <i class="fa fa-shopping-cart" aria-hidden="true"></i>
	Buy</a></h3>
          		<h3>Category:- <?php echo $category; ?></h3>
          		<h4>Service Description:- <?php echo $description; ?></h4>
          	</div>
          </div>
      	</div>
      ...
      <h3>Categories</h3>
        <div class="vertical-menu">
         <a href="shareReview?type=allServices&service=true" class="active">All Services</a>
         <a href="shareReview?type=education&service=true">Education/Course</a>
          <a href="shareReview?type=onlineCourses&service=true">Online Courses</a>
          <a href="shareReview?type=eCommerce&service=true">E-Commerce</a>
          <a href="shareReview?type=meditation&service=true">Spirituality/Meditation</a>
          <a href="shareReview?type=selfAwarness&service=true">Self-awareness</a>
          <a href="shareReview?type=jobs&service=true">Employment/Jobs</a>
          <a href="shareReview?type=movies&service=true">Movies/Music</a>
          <a href="shareReview?type=business&service=true">Business/ Entrepreneurship</a>
          <a href="shareReview?type=publicSpeaking&service=true">Public speaking</a>
          <a href="shareReview?type=coach&service=true">Coach/Mentor</a>
          <a href="shareReview?type=leadership&service=true">Leadership</a>
          <a href="shareReview?type=opportunity&service=true">Best opportunity</a>
          <a href="shareReview?type=otherServices&service=true">Other Services</a>
        </div>
      </div>
  	</div>
